...
function deleteBoard(boardNum) {
	if(confirm("게시물을 삭제 하시겠습니까 ?")) {
		var url="<%=cp%>/board/delete.do?${query}&boardNum="+boardNum;
		location.href=url;
	}
}
</c:if>
        ...
        <div>
			...
			<tr height="45">
			    <td width="300" align="left">
			          <button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/board/reply.do?boardNum=${dto.boardNum}&${query}';">답변</button>
