...
public class MyUtil {
	...
	public int pageCount(int numPerPage, int dataCount) {
	 ...
	 //********************************************
		...
		public String libPaging(int current_page,int boardUID,  int total_page, String list_url) {
			...
			while(page<=total_page && page <=(currentPageSetup+numPerBlock)) {
				if(page==current_page) {
					...
					sb.append("<a href='"+list_url+"id=" + boardUID + "&page="+page+"' class='numBox'>"+page+"</a>");
				}
				page++;
			}
