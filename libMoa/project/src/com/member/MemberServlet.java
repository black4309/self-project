...
public class MemberServlet extends MyServlet {
	...
	private void AdminForm(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// 관리자 로그인 폼
		String path="/WEB-INF/views/member/admin.jsp";
		forward(req, resp, path);
	}

	private void adminSubmit(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// 로그인 처리
		...
		AdminDTO dto=dao.loginAdmin(userId);
		if(dto!=null) {
	...
	private void loginSubmit(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		MemberDTO dto=dao.loginMember(userId);
		if(dto!=null) {
			if(userPwd.equals(dto.getUserPwd())) {
				// 로그인 성공 : 로그인정보를 서버에 저장
				// 세션의 유지시간을 20분설정(기본 30분)
