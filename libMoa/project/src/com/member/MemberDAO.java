...
public class MemberDAO {
	...
	public MemberDTO loginMember(String userId) {
		...
		try {
			String query = "SELECT ID, PASSWORD, NAME, E_MAIL FROM LIB_MEMBER WHERE ID=?";
	...
	public int insertMember(MemberDTO dto) {
		...
		try {
			sb.append("INSERT INTO LIB_MEMBER (MEMBER_UID, ID, PASSWORD, NAME, E_MAIL) VALUES (LIB_MEMBER_SEQ.NEXTVAL, ?, ?, ?, ?)");
			pstmt=conn.prepareStatement(sb.toString());
